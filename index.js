...
import { deepIncrease, heightIncrease, lengthIncrease } from "./actions.js";
// cuboid
const initState = {
	l: 0,
	b: 0,
...
store.dispatch(heightIncrease())
store.dispatch(deepIncrease())
store.dispatch(lengthIncrease())
store.dispatch(lengthIncrease())
store.dispatch(lengthIncrease())
store.dispatch(heightIncrease())
